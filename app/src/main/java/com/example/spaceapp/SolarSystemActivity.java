...
public class SolarSystemActivity extends AppCompatActivity {
    ...
    private String getRandomTopic() {
        String[] topics = {
                "Planets of the Solar System and their unique features",
                "The Sun: Its Influence on the Planets and Space Weather",
                "Planetary Exploration: Past, Present, and Future Missions",
                "The Role of Gravity in the Solar System's Dynamics",
                "Life Beyond Earth: Searching for Habitability in the Solar System"
        };

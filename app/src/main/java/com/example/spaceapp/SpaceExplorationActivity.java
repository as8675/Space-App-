...
public class SpaceExplorationActivity extends AppCompatActivity {
    ...
    protected void loadQuestions() {
        ...
        questionsList.add(new Question("Who was the first person to walk on the Moon?",
                new String[]{"Yuri Gagarin", "Neil Armstrong", "Buzz Aldrin", "John Glenn"}, 1));
        questionsList.add(new Question("Which spacecraft was the first to leave the Solar System?",
                new String[]{"Voyager 1", "Voyager 2", "Pioneer 10", "New Horizons"}, 0));
        questionsList.add(new Question("What was the name of the first artificial Earth satellite?",
                new String[]{"Sputnik 1", "Explorer 1", "Tiangong 1", "Hubble Space Telescope"}, 0));
        questionsList.add(new Question("Which space agency successfully landed the Perseverance rover on Mars?",
                new String[]{"Roscosmos", "European Space Agency", "NASA", "SpaceX"}, 2));
        questionsList.add(new Question("What is the name of the telescope that has provided us with many pictures of outer space since its launch in 1990?",
                new String[]{"James Webb Space Telescope", "E Hubble Space Telescope", "Kepler Space Telescope", "Chandra X-ray Observatory"}, 1));
    }
